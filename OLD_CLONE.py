...
def helpnote():
	...
	exit(" [*] FACEBOOK :  https://www.facebook.com/halarput.link.coppy.korli.ken")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +01828881765")
	subprocess.check_output(["am", "start", "https://wa.me/+01828881765"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/ASIM-404/OLD-CLONE/main/Approve.txt').text
			if basesplit in plr:
				key = basesplit
